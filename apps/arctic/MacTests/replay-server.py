...
class Handler(BaseHTTPRequestHandler):
 def do_GET(self):
  if self.path == '/cover.svg':
   b=b'<svg xmlns="http://www.w3.org/2000/svg" width="640" height="400"><rect width="640" height="400" fill="#709ea8"/></svg>'
  ...
  body='<html><head><meta charset="utf-8"><title>'+title+'</title><meta property="og:title" content="'+title+'"><meta property="og:image" content="http://127.0.0.1:8766/cover.svg"><meta name="description" content="An Arctic desktop replay. Local pages, no publisher requests."></head><body><article><h1>'+title+'</h1>'
