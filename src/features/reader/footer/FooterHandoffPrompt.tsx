    ...
    >
      <div className="mx-auto flex max-w-[min(100%,34rem)] items-center gap-1.5 rounded-full border border-border/80 bg-background p-1 shadow-lg shadow-background/20 backdrop-blur-xl">
        <button
          ...
          className="group flex min-w-0 flex-1 items-center gap-2 rounded-full px-2 py-1.5 text-left transition-[background-color,opacity,transform,scale] duration-150 ease-[cubic-bezier(0.23,1,0.32,1)] hover:bg-secondary/70 active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/60 motion-reduce:active:scale-100 motion-reduce:active:opacity-80"
        >
