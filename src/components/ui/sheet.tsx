  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Popup
        ...
        className={cn(
          "bg-background data-[open]:animate-in data-[closed]:animate-out fixed z-50 flex flex-col gap-0 shadow-lg transition ease-in-out data-[closed]:duration-250 data-[open]:duration-250",
          side === "right" &&
