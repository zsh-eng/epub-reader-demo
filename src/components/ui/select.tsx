  ...
  return (
    <SelectPrimitive.Portal>
      ...
      <SelectPrimitive.Popup
        ...
        className={cn(
          "bg-popover text-popover-foreground transition-[opacity,scale,filter] duration-150 ease-[cubic-bezier(0.23,1,0.32,1)] data-[ending-style]:opacity-0 data-[ending-style]:scale-[0.98] data-[ending-style]:blur-[4px] relative z-50 max-h-(--available-height) min-w-[8rem] origin-(--transform-origin) overflow-x-hidden overflow-y-auto rounded-[calc(var(--radius-sm)+5px)] border shadow-md",
          position === "popper" &&
