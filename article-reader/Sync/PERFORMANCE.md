...
```sh
python3 article-reader/Tests/check-article-sync.py
python3 article-reader/Tests/check-article-sync.py --configuration release --performance
python3 article-reader/Tests/check-article-sync.py --performance
